...
**Q4 automated runner:** `powershell -File tools/run-q4-trust-matrix.ps1` â€” see [Q4_TRUST_MATRIX_RUNBOOK.md](./Q4_TRUST_MATRIX_RUNBOOK.md).
...
1. Sync panel â†’ endpoint `http://127.0.0.1:8787` â†’ **Register device**
2. Push bundle with passphrase
3. Pull on second profile or after local wipe
4. Resolve conflicts via Sync panel buttons

Cloud deploy: optional â€” see [SYNC_SERVER.md](./SYNC_SERVER.md) Â§ Cloud deploy (deferred).
